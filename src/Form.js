...
<button className='playagain' onClick={handlePlayAgain}>PLAY AGAIN</button> 
 {/* yo talako quit button lai Link tag le wrap gara like below*/ }
 {/* <Link to = '/homepage'><button className = 'quitgame'>QUIT GAME</button>*/}
 {/*/homepage chai homepage ko link vayo jun App.js ma pani xa */}
